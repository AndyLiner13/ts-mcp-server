...
export function register(server: McpServer): void {
  server.registerTool(
    "get_code_fixes",
    {
      ...
      description:
        "Get available code fixes for specific error codes at a range in a TypeScript/JavaScript file. Returns the raw list of code actions tsserver suggests for the given diagnostics. Use get_diagnostics first to discover error codes and ranges, then pass them here.",
      annotations: {
        readOnlyHint: true,
      },
